...
class UploadUrlAndImages(models.Model):
    ...
    url = models.URLField()
    image_urls = models.CharField(max_length=5000)
...
class Motion_Log(models.Model):
    camera_id=models.CharField(max_length=300,blank=True,null=True)
    detection_time=models.DateTimeField(blank=True,null=True)
    image_data=models.BinaryField(blank=True,null=True)

        
        
class UploadMotionUrl(models.Model):
    camera_id=models.CharField(max_length=300)
    url=models.URLField()