...
urlpatterns = [
    ...
    path('upload_url_motion_detection',views.upload_url_motion_detection,name='urlmotionupload'),
    path('startcamera_motion_detection',views.start_camera_motion_detection,name='motiondetectionstart'),
    path('stopcamera_motion_detection',views.stop_camera_motion_detection,name='motiondetectionstop'),
